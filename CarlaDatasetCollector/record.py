...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        line_list=[]
        temp_list=[]
        temp_list = copy.deepcopy(self._info_text)
        if isinstance(c, carla.VehicleControl):
            ...
            temp_list += [
                ('Throttle: %.2f' % c.throttle),('Steer: %.2f' % c.steer),('Brake: %.2f' % c.brake),('Reverse: %r' % c.reverse),('Hand brake: %r' % c.hand_brake),('Manual: %r' % c.manual_gear_shift)
            ]
