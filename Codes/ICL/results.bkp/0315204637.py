'''Question: In a safe dense traffic scenario, during a clear afternoon, there are 30 vehicles and 25 pedestrians sharing the road. Some pedestrians are walking briskly, while others are waiting for traffic lights to change. Safe vehicles operate in autonomous mode, prioritizing pedestrian safety and maintaining a constant speed.'''
import utils 
