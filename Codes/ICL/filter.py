...
def main():
    ...
    config_file = "../CarlaPy/template_autoSceneGen.py" # TODO: Change this to your own configuration file!
    compatible_words = load_configuration(config_file)
    # Example of arbitrary input text
    input_text = "import something; that is valuable to you from utils! Try not to configure all the configs! Written by: Alexander."
    # Filter text
