'''Question: In a safe sparse traffic scenario, during a wet and cloudy sunset, there are 3 vehicles and 2 pedestrians on the road. One of the vehicles is being driven dangerously, exhibiting negligence towards traffic signs and lights. The pedestrians and vehicles maintain a safe distance from each other.'''
import utils 
def generate_scenario():
    vehicles_count = 3 
    walkers_count = 2 
    percentage_pedestrians_running = 0.0
    weather = utils.WeatherPresets.WetCloudySunset 
