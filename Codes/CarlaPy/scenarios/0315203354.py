'''Question: In a safe sparse traffic scenario, during a clear sunset, there are 3 vehicles and 2 pedestrians on the road. One of the vehicles is being driven dangerously, exhibiting negligence towards traffic signs. The pedestrians and vehicles maintain a safe distance from each other.'''
import utils 
...
def generate_scenario():
    ...
    traffic_manager.distance_to_leading_vehicle(dangerous_vehicle, 50) 
